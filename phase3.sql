...
--
-- Host: localhost
-- Generation Time: Apr 24, 2016 at 09:58 PM
...
CREATE TABLE IF NOT EXISTS `Reserves` (
  ...
  `Departs_From` varchar(25) NOT NULL,
  `Arrives_At` varchar(25) NOT NULL,
...
(1, '114885', 'First Class', '2016-01-06', 'Dustin Archer', 1, 'Big Four Depot', 'Chicago Union Station'),
...
(4, '743603', 'Second Class', '2016-02-04', 'Rong Chang', 2, 'Boston Back Bay', 'Chicago Union Station'),
(4, '958273', 'First Class', '2016-01-28', 'Rong Chang', 4, 'Chicago Union Station', 'Penn Station'),
(5, '671373', 'Second Class', '2016-02-10', 'Martha Vargas', 3, 'Fremont Station', 'Big Four Depot'),
(6, '114885', 'Second Class', '2016-02-23', 'Doris Bailey', 4, 'Big Four Depot', 'Chicago Union Station'),
...
(11, '958273', 'Second Class', '2016-03-16', 'Kerstin Ortiz', 0, 'Chicago Union Station', 'Penn Station'),
...
(14, '114885', 'Second Class', '2016-03-29', 'Harold Stone', 1, 'Big Four Depot', 'Chicago Union Station'),
(15, '114885', 'First Class', '2016-03-29', 'Suresh Narayan', 0, 'Big Four Depot', 'Chicago Union Station'),
(15, '743603', 'Second Class', '2016-04-04', 'Suresh Narayan', 2, 'Boston Back Bay', 'Chicago Union Station'),
...
(18, '958273', 'Second Class', '2016-04-18', 'Mickey Sloan', 0, 'Chicago Union Station', 'Penn Station'),
(19, '631289', 'First Class', '2016-04-19', 'Rong Chang', 2, 'Penn Station', 'Fremont Station'),
(20, '743603', 'Second Class', '2016-04-23', 'Martha Vargas', 1, 'Boston Back Bay', 'Chicago Union Station'),
(21, '114885', 'First Class', '2016-04-27', 'Dustin Archer', 4, 'Big Four Depot', 'Chicago Union Station'),
(21, '958273', 'Second Class', '2016-03-27', 'Dustin Archer', 3, 'Chicago Union Station', 'Penn Station'),
(22, '671373', 'Second Class', '2016-04-29', 'Jamie Mcguire', 0, 'Fremont Station', 'Big Four Depot'),
(23, '958273', 'Second Class', '2016-05-02', 'Mickey Sloan', 3, 'Chicago Union Station', 'Penn Station'),
...
(28, '743603', 'Second Class', '2016-05-11', 'Louise Best', 2, 'Boston Back Bay', 'Chicago Union Station'),
(29, '397782', 'Second Class', '2016-05-12', 'Nadin Williams', 1, 'Fremont Station', 'Boston Back Bay'),
(30, '958273', 'First Class', '2016-05-14', 'Chung Huang', 3, 'Chicago Union Station', 'Penn Station'),
(31, '114885', 'Second Class', '2016-02-20', 'Kerstin Ortiz', 0, 'Big Four Depot', 'Chicago Union Station'),
...
(34, '743603', 'Second Class', '2016-05-20', 'Harold Stone', 0, 'Boston Back Bay', 'Chicago Union Station'),
(35, '114885', 'First Class', '2016-05-24', 'Suresh Narayan', 4, 'Big Four Depot', 'Chicago Union Station'),
(36, '743603', 'Second Class', '2016-05-25', 'Dustin Archer', 1, 'Boston Back Bay', 'Chicago Union Station'),
...
(40, '423054', 'First Class', '2016-05-31', 'Martha Vargas', 1, 'Big Four Depot', 'Peachtree Station'),
...
('114885', 'Chicago Union Station', '20:05:00', '21:00:00'),
...
('631289', 'Chicago Union Station', '13:30:00', '13:40:00'),
...
INSERT INTO `System_Info` (`Max_Bags`, `No_Free_Bags`, `StudentDiscount`, `ChangeFee`) VALUES
(4, 2, 30.00, 50.00);
...
-- in use(#1142 - SHOW VIEW command denied to user 'cs4400_Team_45'@'localhost' for table 'X')
...
ALTER TABLE `Reserves`
  ADD CONSTRAINT `Reserves_ibfk_3` FOREIGN KEY (`Reservation_ID`) REFERENCES `Reservation` (`Reservation_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
