...
--
-- Host: localhost
-- Generation Time: Apr 23, 2016 at 12:29 AM
...
ALTER TABLE `Reserves`
  ...
  ADD CONSTRAINT `Reserves_ibfk_3` FOREIGN KEY (`Reservation_ID`) REFERENCES `Reserves` (`Reservation_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
